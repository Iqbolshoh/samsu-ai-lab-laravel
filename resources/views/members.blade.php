    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-200 relative">
                    <!-- Member Image -->
                    <div class="relative h-80 overflow-hidden bg-gradient-to-br from-primary-50 to-secondary-50">
                        @if ($member->image)
                        <img
                            src="{{ str_starts_with($member->image, 'http') ? $member->image : asset('storage/'.$member->image) }}"
                            alt="{{ $member->name_en }}"
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-primary-900/90 via-primary-700/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-end pb-8 px-6">
                            @if($member->email)
                    ...
                    <div class="p-6 relative">
                        ...
                        <div class="absolute -top-3 left-6">
                            <span class="text-xs font-semibold px-3 py-1 rounded-full bg-primary-100 text-primary-700 border border-primary-200 shadow-sm">
                                {{ $member->role_en }}
                            </span>
                        </div>

                        <!-- Name -->
                        <h3 class="text-xl font-bold text-gray-900 mb-3 pt-2"
                            data-key-en="{{ $member->name_en }}"
                        ...
                        <div class="flex items-center justify-center gap-4 pt-4 border-t border-gray-100">
                            ...
                            <a href="mailto:{{ $member->email }}"
                                ...
                                title="Email">
                                <div class="w-10 h-10 rounded-full bg-primary-50 flex items-center justify-center group-hover/icon:bg-primary-100 transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                </div>
                                <div class="absolute -top-10 left-1/2 transform -translate-x-1/2 px-3 py-2 bg-gray-900 text-white text-xs rounded opacity-0 group-hover/icon:opacity-100 transition-opacity whitespace-nowrap z-10">
                                    {{ $member->email }}
            ...
            <div class="text-center py-20 text-gray-500">
                ...
                <h3 class="text-2xl font-semibold mb-3" data-key-uz="A'zolar hali yo'q" data-key-en="No members available yet">
                    No members available yet
                </h3>
                <p class="text-gray-600 max-w-md mx-auto" data-key-uz="Iltimos, keyinroq tekshiring." data-key-en="Please check back later for new members.">
            ...
            <div class="mt-16">
                <nav class="flex items-center justify-center space-x-2">
                    ...
                    <span class="px-4 py-2 text-sm font-medium text-gray-400 bg-gray-100 border border-gray-300 rounded-lg cursor-not-allowed flex items-center gap-1">
                    ...
                    <span class="px-4 py-2 text-sm font-semibold bg-primary-600 text-white border border-primary-600 rounded-lg">{{ $page }}</span>
                    @else
                    <a href="{{ $url }}"
