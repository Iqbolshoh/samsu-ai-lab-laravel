...
@section('title', 'AI Laboratory | Projects')
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        @foreach ($projects as $project)
                            <div
                                ...
                                <div class="p-6">
                                    ...
                                    <h3 class="text-xl font-bold text-secondary-900 mb-3" data-key-uz="{{ $project->title_uz }}"
                ...
                @else
                    <div class="text-center py-20 text-secondary-500">
                        <h3 class="text-xl font-semibold mb-2" data-key-uz="Loyihalar topilmadi"
                            data-key-en="No projects found">
                        </h3>
