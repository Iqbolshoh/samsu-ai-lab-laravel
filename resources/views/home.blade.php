                            ...
                            <div class="swiper-slide">
                                <div class="absolute inset-0">
                                    <img src="{{ $banner->image ? (str_starts_with($banner->image, 'http') ? $banner->image : asset('storage/' . $banner->image)) : 'https://placehold.co/1920x1080?text=No+Image' }}"
                                        class="w-full h-full object-cover" alt="{{ $banner->title_uz }}">
                                    <div class="absolute inset-0 bg-gradient-to-b from-white/80 via-white/60 to-primary-900/60">
                                    </div>
                                </div>

                                <div class="relative h-full flex items-center">
                                    <div class="max-w-5xl mx-auto px-6 text-center">
                                        <h1 class="text-4xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-primary-700 to-primary-500 bg-clip-text text-transparent"
                                            data-key-uz="{{ $banner->title_uz }}" data-key-en="{{ $banner->title_en }}">
                                        </h1>

                                        <p class="text-lg md:text-2xl text-secondary-700 mb-10 max-w-3xl mx-auto"
                                            data-key-uz="{{ $banner->subtitle_uz }}" data-key-en="{{ $banner->subtitle_en }}">
                                        </p>
