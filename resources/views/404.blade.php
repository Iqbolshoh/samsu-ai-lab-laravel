...
@section('title', 'AI Laboratory | Not Found')

@section('content')

    <div
        class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-secondary-50 to-secondary-100 px-4">
        <!-- Icon -->
        <div class="mb-8">
        ...
        <!-- Description -->
        <p class="text-center text-secondary-500 mb-8 max-w-xl" data-key-uz="Siz izlayotgan sahifa mavjud emas."
