        ...
        <section class="py-20 bg-gradient-to-b from-white to-primary-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4" data-key-en="Our partners"
                ...
                <div class="space-y-6">
                    @foreach ($collaborations as $collaboration)
                        <div
                            class="w-full bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 overflow-hidden group">
                            <div class="flex flex-col md:flex-row">
                                <!-- Left: Image -->
                                <div
                                    class="md:w-1/4 lg:w-1/5 bg-gradient-to-br from-gray-50 to-white p-8 flex items-center justify-center">
                                    ...
                                    @else
                                        <div
                                            class="w-32 h-32 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center text-white">
                                ...
                                <div class="md:w-3/4 lg:w-4/5 p-8 flex flex-col justify-center">
                                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                        ...
                                        <span
                                            class="inline-flex px-3 py-1 text-sm font-semibold rounded-full bg-primary-100 text-primary-700">
                ...
                <div class="grid lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        <div class="text-left mb-10">
                            <h2 class="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent mb-6"
                                data-key-en="{{ $contact->title_en }}" data-key-uz="{{ $contact->title_uz }}"></h2>
                        ...
                        <form id="collaborationForm" class="space-y-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label for="firstName" class="block text-sm font-medium text-secondary-700 mb-2"
                                        data-key="collaboration.form.fields.firstName"></label>
                                ...
                                <div>
                                    <label for="lastName" class="block text-sm font-medium text-secondary-700 mb-2"
                                        data-key="collaboration.form.fields.lastName"></label>
                            ...
                            <div>
                                <label for="email" class="block text-sm font-medium text-secondary-700 mb-2"
                                    data-key="collaboration.form.fields.email"></label>
                                <input type="email" id="email" name="email" required
                                    class="w-full px-4 py-3 rounded-xl border border-secondary-300 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all duration-200 outline-none">
                            </div>

                            <div>
                                <label for="organization" class="block text-sm font-medium text-secondary-700 mb-2"
                                    data-key="collaboration.form.fields.organization"></label>
                                <input type="text" id="organization" name="organization" required
                                    class="w-full px-4 py-3 rounded-xl border border-secondary-300 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all duration-200 outline-none">
                            </div>

                            <div>
                                <label for="collaborationType" class="block text-sm font-medium text-secondary-700 mb-2"
                                    data-key="collaboration.form.fields.type">
                                </label>

                                <input type="text" id="collaborationType" name="collaboration_type" required placeholder=""
                                    data-key-en="Type of collaboration" data-key-uz="Hamkorlik turini yozing" class="w-full px-4 py-3 rounded-xl border border-secondary-300 
                            ...
                            <div>
                                <label for="message" class="block text-sm font-medium text-secondary-700 mb-2"
                                    data-key="collaboration.form.fields.message"></label>
                    ...
                    <div>
                        @if($contact)
                            ...
                            <div class="mb-8">
                                <div
                                    class="bg-gradient-to-br from-primary-50 to-white rounded-2xl p-8 border border-secondary-200 shadow-lg">
                                    <h3 class="text-2xl font-bold text-secondary-900 mb-6"
                                        data-key="collaboration.contact.quick"></h3>
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="flex items-start gap-5">
                                            ...
                                            <div>
                                                <p class="font-semibold text-gray-900 mb-1"
                                                    data-key="collaboration.contact.address"></p>
                                        ...
                                        <div class="flex items-start gap-5">
                                            ...
                                            <div>
                                                <p class="font-semibold text-gray-900 mb-1"
                                                    data-key="collaboration.contact.email"></p>
                                                @if($contact->email_1)
                                                    <a href="mailto:{{ $contact->email_1 }}"
                                                        class="text-gray-600 hover:text-primary-600 transition-colors block">{{ $contact->email_1 }}</a>
                                                @endif
                                                @if($contact->email_2)
                                                    <a href="mailto:{{ $contact->email_2 }}"
                                                        class="text-gray-600 hover:text-primary-600 transition-colors block">{{ $contact->email_2 }}</a>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start gap-5">
                                            ...
                                            <div>
                                                <p class="font-semibold text-gray-900 mb-1"
                                                    data-key="collaboration.contact.phone"></p>
                                                @if($contact->phone_1)
                                                    <a href="tel:{{ str_replace(' ', '', $contact->phone_1) }}"
                                                        class="text-gray-600 hover:text-primary-600 transition-colors block">{{ $contact->phone_1 }}</a>
                                                @endif
                                                @if($contact->phone_2)
                                                    <a href="tel:{{ str_replace(' ', '', $contact->phone_2) }}"
                                                        class="text-gray-600 hover:text-primary-600 transition-colors block">{{ $contact->phone_2 }}</a>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start gap-5">
                                            ...
                                            <div>
                                                <p class="font-semibold text-gray-900 mb-1"
                                                    data-key="collaboration.contact.hours"></p>
