            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <header class="mb-8">
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center gap-4">
                            ...
                            <span
                                class="inline-block px-4 py-1.5 bg-primary-50 text-primary-600 rounded-full text-sm font-semibold"
                                data-key-uz="Yangiliklar" data-key-en="News">Yangiliklar</span>
                ...
                <figure class="mb-10">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl border border-secondary-200">
                        <img id="articleImage" src="{{ asset('storage/' . $news->image) }}" alt="{{ $news->title_en }}"
